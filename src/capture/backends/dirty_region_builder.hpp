...
public:
    ...
    struct Statistics {
        ...
        std::uint64_t frames_without_metadata = 0;
    ...
    void force_full_surface_without_metadata() noexcept;
    ...
    [[nodiscard]] bool metadata_absent() const noexcept { return metadata_absent_; }
